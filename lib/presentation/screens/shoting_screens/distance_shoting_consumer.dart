...
class DistanceConsumerWidget extends ConsumerStatefulWidget {
  
  const DistanceConsumerWidget({super.key});

  @override
  ConsumerState<DistanceConsumerWidget> createState() =>
      _DistanceConsumerWidgetState();
}

class _DistanceConsumerWidgetState extends ConsumerState<DistanceConsumerWidget> {
  ...
  //   setState(() {});
  //   final file = await widget.cameraController.takePicture();
  //   setState(() {});
